	...
	<body>
		...
		<div class="mainScreen">
							...
							<tr>
								...
								<td>
									<form action="receptionistNavServlet" method="post">
										...
										<input type="submit" name="editPatientData" value="Edit"/>
									</form>
								</td>
								<td>
									<form action="receptionistNavServlet" method="post">
										...
										<input type="hidden" name="fname" value="<%=fname %>"/>
										<input type="hidden" name="patientId" value="<%=patient.getId() %>"/>
										<input type="submit" name="schedulePatientAppointment" value="Schedule"/>
									</form>
								</td>
							</tr>
							<%
			...
			<form action="receptionistNavServlet" method="post">
				<input type="hidden" name="id" value="<%=id %>"/>
				<input type="hidden" name="fname" value="<%=fname %>"/>
				<input type="submit" name="newPatient" value="Add new patient"/>
			</form>
		</div>
	</body>
</html>